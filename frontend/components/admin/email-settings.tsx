        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-muted-foreground">Enable SMTP authentication for sending emails</p>
            </div>
            <Switch id="smtp-auth" defaultChecked />
          </div>
          <div className="space-y-2">
            <Label htmlFor="from-email">From Email Address</Label>
            <Input id="from-email" defaultValue="notifications@logisticsplatform.com" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="from-name">From Name</Label>
            <Input id="from-name" defaultValue="Logistics Platform" />
          </div>
          <div className="space-y-2">
            <Label htmlFor="reply-to">Reply-To Email Address</Label>
            <Input id="reply-to" defaultValue="support@logisticsplatform.com" />
          </div>
          <div className="pt-4">
          ...
          <Tabs defaultValue="welcome">
            ...
            <TabsContent value="welcome" className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <Input id="welcome-subject" defaultValue="Welcome to Logistics Platform" />
              </div>
              <div className="space-y-2">
...
<p>Best regards,<br>The Logistics Platform Team</p>`}
            ...
            <TabsContent value="reset-password" className="space-y-4 pt-4">
              <div className="space-y-2">
                <Label htmlFor="reset-subject">Subject</Label>
                <Input id="reset-subject" defaultValue="Reset Your Password" />
              </div>
              <div className="space-y-2">
...
<p>Best regards,<br>The Logistics Platform Team</p>`}
            ...
            <TabsContent value="order-confirmation" className="space-y-4 pt-4">
              <div className="space-y-2">
                <Label htmlFor="order-subject">Subject</Label>
                <Input id="order-subject" defaultValue="Order Confirmation - #{{orderNumber}}" />
              </div>
              <div className="space-y-2">
...
<p>Best regards,<br>The Logistics Platform Team</p>`}
            ...
            <TabsContent value="invoice" className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <Input id="invoice-subject" defaultValue="Invoice #{{invoiceNumber}} for Order #{{orderNumber}}" />
              </div>
              <div className="space-y-2">
