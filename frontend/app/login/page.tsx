...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // In a real app, you would redirect to the dashboard after successful login
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-muted/40 p-4">
      ...
      <div className="text-white  flex min-h-screen flex-col items-center justify-center bg-muted/40 p-4">
        <Card
          className={`flex flex-col gap-4 p-6 shadow-sm transition-all hover:shadow-md border border-[#1b2638] bg-[#0a0e1a] text-white`}
        >
