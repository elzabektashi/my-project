...
export const createOrder = async (req, res) => {
    const orderRepo = AppDataSource.getRepository(Order);
    const { order_date, destination, cargo_description, company_id, vehicle_id, driver_id, } = req.body;
...
export const updateOrder = async (req, res) => {
    ...
    const { order_date, destination, cargo_description, company_id, vehicle_id, driver_id, status, } = req.body;
